...
class _ObitoSerpente extends State<ObitoSerpente> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Registro de óbitos', style: Theme.of(context).textTheme.headline1),
        ...
        child: Container(
          ...
          child: Form(
            ...
            child: Column(children: [
              ...
              WCampoTexto(rotulo: 'Causa mortis', variavel: obitoController.txtCausa, eSenha: false),
              WBotao(rotulo: 'Registrar óbito'),
            ]),
          ),
        )));
  }
